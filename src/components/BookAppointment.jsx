              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                <div className='relative'>
                  <input
                    ...
                    className='w-full p-4 pl-12 border-2 border-gray-200 transition rounded-xl focus:border-sky-500 focus:ring-2 focus:ring-sky-200 outline-none'
                    required
                    min={new Date().toISOString().split('T')[0]}
                  />
                  <FaCalendarAlt className='absolute left-4 top-1/2 tranform -translate-y-1/2 text-gray-400' />
                </div>
                <div className='relative'>
                  <select
                    name="time"
