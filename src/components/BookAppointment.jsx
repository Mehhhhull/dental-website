          ...
          {activeStep === 3 && (
            <div className='p-8 text-center'>
              ...
              <div className='bg-sky-50 rounded-xl p-6 mb-8 text-left max-w-md mx-auto'>
                <div className='flex justify-between py-2 border-b border-sky-100'><span className='text-gray-600'>Name:</span><span className='font-medium'>{formData.name}</span></div>
                <div className='flex justify-between py-2 border-b border-sky-100'><span className='text-gray-600'>Phone:</span><span className='font-medium'>{formData.phone}</span></div>
                <div className='flex justify-between py-2 border-b border-sky-100'><span className='text-gray-600'>Date:</span><span className='font-medium'>{formData.date}</span></div>
                <div className='flex justify-between py-2 border-b border-sky-100'><span className='text-gray-600'>Time:</span><span className='font-medium'>{formData.time}</span></div>
                <div className='flex justify-between py-2 border-b border-sky-100'><span className='text-gray-600'>Service:</span><span className='font-medium'>{formData.service}</span></div>
              </div>
              <button
