...
const Testimonials = () => {
  ...
  return (
    <section
      id="testimonials"
      className="scroll-mt-20 relative py-24 bg-gradient-to-r from-blue-50 to-sky-50 overflow-hidden"
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative overflow-hidden">
          ...
          <div key={testimonial.id} className="min-w-full flex-shrink-0 px-4">
                      ...
                      <div>
                        ...
                        <div className="hidden md:flex space-x-2 mt-4">
                          <button
                            ...
                            className="p-2 rounded-full bg-sky-200 text-sky-800 hover:bg-sky-300 transition-colors"
                          >
                            <FaChevronLeft />
                          </button>
                          <button
