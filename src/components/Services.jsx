      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            At Smile Dental Clinic, we offer a wide range of dental services to meet all your oral health needs. From routine check-ups to advanced cosmetic procedures, our team is here to help you achieve a healthy and beautiful smile.
          </p>
        </div>
