  ...
  const tips = [
    {
      ...
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur dolores neque expedita ullam perspiciatis ratione libero tempore maxime, accusamus deserunt!',
      icon: <GiToothbrush className='w-8 h-8 text-sky-500' />,
    },
    {
      title: 'Cavity Preventation ',
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur dolores neque expedita ullam perspiciatis ratione libero tempore maxime, accusamus deserunt!',
    ...
    },
    {
      ...
      content: 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur dolores neque expedita ullam perspiciatis ratione libero tempore maxime, accusamus deserunt!',
      icon: <FaSmile className='w-8 h-8 text-purple-500' />,
    },
  ]
  return (
